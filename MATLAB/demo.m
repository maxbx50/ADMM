...
[u_vec,d_vec,lamb_vec,distv,mesh] = admm_l2(32,@fun,50,7.0);

%Alternatively:

%Y = H_curl, bestapproximation of shrinkage approach
%[u_vec,d_vec,lamb_vec,distv,mesh] = admm_l2_ned(32,@fun,50,7.0);

%Y = H_curl, regularization approach
%[u_vec,d_vec,lamb_vec,distv,mesh] = admm_curl(32,@fun,50,7.0);

%Chambolle and Pocks method
%[u_vec,d_vec,u_bar_vec,distv,mesh] = cham_pock(32,@fun,50);
