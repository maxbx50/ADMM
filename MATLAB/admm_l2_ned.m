function [u_vec,d_vec,lamb_vec,distv,mesh] = admm_l2_ned(N,f,it,gamma)
%ADMM_L2_NED
...
while(dist>tol && k<it)
    ...
    %...using a lumped mas matrix
    %d = sparse(mesh.edges_elements,1,L_ned)./M_ned_lumped;
